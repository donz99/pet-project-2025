...
public class Solution {
    ...
    public static void removeBugWithFor(ArrayList<String> list) {
        ...
        for (int i=0;i<list.size();i++){
            if (list.get(i).equals("bug")||list.get(i).equals("BUG")||list.get(i).equals("Bug")||list.get(i).equals("buG")||list.get(i).equals("bUg")||list.get(i).equals("BUg")||list.get(i).equals("bUG")||
                    list.get(i).equals("BuG")){
                list.remove(i);
                i--;
            }
        }
